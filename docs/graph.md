...
- The graph now ends with typed workflow state. Response wording is generated later by `ChatResponseService` and presented by `ChatPresenter`, outside the workflow.
