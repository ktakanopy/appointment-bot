...
- `verify` is the single gatekeeper for protected actions: it either passes through, asks for the next verification field, returns a validation error, or locks the session after repeated failures.
